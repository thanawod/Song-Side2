...
music.addEventListener('ended',()=>{
    ...
    Array.from(document.getElementsByClassName('song_item'))[`${index-8}`].style.background = "rgb(105, 105, 170, .1)";
    makeAllPlays();
    document.getElementsByClassName('playListPlay')[index-7].classList.remove('bi-play-circle-fill');
    document.getElementsByClassName('playListPlay')[index-7].classList.add('bi-pause-circle-fill');
})
